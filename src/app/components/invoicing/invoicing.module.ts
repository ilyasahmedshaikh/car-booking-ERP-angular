...
@NgModule({
  declarations: [InvoicingComponent, InvoicesComponent, OutstandingComponent, PaidComponent, SettingsComponent, CreateInvoiceComponent, CreateInvoicesComponent, SettingsTabComponent, RecordPaymentComponent, OutstandingInvoicesComponent, PaidInvoicesComponent, PaymentTermsTabComponent, CommentsTabComponent, InvoiceTemplateComponent],
  imports: [
    CommonModule,
