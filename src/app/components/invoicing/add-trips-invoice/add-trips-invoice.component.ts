...
@Component({
  selector: 'app-add-trips-invoice',
  templateUrl: './add-trips-invoice.component.html',
  styleUrls: ['./add-trips-invoice.component.scss']
})
export class AddTripsInvoiceComponent implements OnInit {
